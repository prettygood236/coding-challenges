...
#. Learned about 
#. Tree Structure: A nonlinear data structure with a hierarchical structure. The tree is composed of nodes, consisting of a root node and its child nodes.
#. How to use DFS (Depth-First Search) and the defaultdict library.
# 문제 설명
